...
enum LegacyMaterial {
    ...
    LegacyMaterial(String location, int id, float damage, Item item) {
    ...
    public static LegacyMaterial getByBase(Item item) {
        for (LegacyMaterial mat : values())
            if (mat.item == item)
                return mat;
        return WOODEN_SWORD;
    }

    public static LegacyMaterial getById(int id) {
        for (LegacyMaterial mat : values())
            if (mat.id == id)
                return mat;
        return WOODEN_SWORD;
    ...
    public static LegacyMaterial getByLocation(String location) {
        for (LegacyMaterial mat : values())
            if (mat.location.equals(location))
                return mat;
        return WOODEN_SWORD;
    }
